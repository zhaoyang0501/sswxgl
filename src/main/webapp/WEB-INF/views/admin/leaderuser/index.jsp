...
<head>
<script type="text/javascript" src="${pageContext.request.contextPath}/admin/js/ace/admin.leaderuser.js"></script>
						...
						<div class="content-widgets light-gray">
							...
							<div class="box well form-inline">
								...
								<a onclick="$.adminAdminuser.initSearchDataTable()"
									...
									<a class="btn btn-success"  onclick="$.adminAdminuser.showaddModal()"><i class="icon-plus"></i> 新增</a>

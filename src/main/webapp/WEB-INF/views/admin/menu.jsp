...
<div class="leftbar leftbar-close clearfix">
	<div class="admin-info clearfix">
		...
		<div class="admin-meta">
			<ul>
				<li class="admin-username" style="margin-top: 10px;">欢迎你 ${sessionScope.adminuser.name}，${sessionScope.adminuser.dept}</li>
			...
			<div class="tab-pane active dailyreport" id="dailyreport">
				<ul id="nav" class="accordion-nav" >
					...
					<li><a href="${pageContext.request.contextPath}/admin/adminuser/centerdetail"><i class="icon-upload"></i>个人中心 </a></li>
					 ...
					 <c:if test="${sessionScope.adminuser.dept=='超级管理员'||sessionScope.adminuser.dept=='宿管理员'}">
						<li><a href="${pageContext.request.contextPath}/admin/adminuser/index"><i class="icon-upload"></i>学生管理</a></li>

...
public class LeaderAction extends ActionSupport {
	...
	@Action(value = "index", results = { @Result(name = "success", location = "/WEB-INF/views/admin/leaderuser/index.jsp") })
	public String index() {
		return SUCCESS;
	}
	/***
	...
	public String list() {
		...
		Page<AdminUser> list = adminUserService.findAll(pageNumber, pageSize,name,realname,"宿管员");
